...
module.exports = class RememberCommand extends Command {
  ...
  async run({ message, args, server }, t) {
    ...
    collector.on('collect', async (m) => {
      ...
      if (Number.isNaN(tempoTotal) || tempoTotal === undefined) return message.menheraReply('error', t('commands:remember.error'));

      // Enviando a mensagem e criando o coletor de emojis usando promises
      message.menheraReply('question', t('commands:remember.confirm-message', { days, hours, minutes: min }))
