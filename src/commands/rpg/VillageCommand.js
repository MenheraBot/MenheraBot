...
module.exports = class VillageCommand extends Command {
    ...
    async run(message, args) {
        ...
        collector.on('collect', m => {
            ...
            switch (m.content) {
                case '1':
                    this.bruxa(message, user, msg)
                    break
                case '2':
                    this.ferreiro(message, user, msg)
                    break;
                case '3':
                    this.hotel(message, user, msg)
                    break
                case '4':
                    this.guilda(message, user, msg)
                    break;
            }
        })
    }
    ...
    ferreiro(message, user, msg) {
        ...
        collector.on('collect', m => {
            ...
            if (m.content === "1") {
                this.ferreiroArma(message, user, msg)
            } else if (m.content === "2") {
                this.ferreiroArmadura(message, user, msg)
