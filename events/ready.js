...
module.exports = (client) => {
  ...
  let status = [{
      name: "a moon ser perfeita",
      type: "WATCHING"
    },
    {
      name: "o meu servidor de suporte m!suporte",
      type: "LISTENING"
    },
    {
      name: "sabia que a moon é a salvação da minha dona? sem moon, menhera = inexistente m!moon",
      type: "PLAYING"
    },
    {
      name: "a vida é dificil, mas estamos aqui pra facilitá-la",
      type: "PLAYING"
    },
    {
      name: "já votou em mim hoje? m!votar",
      type: "PLAYING"
    },
    {
      name: "Caçe demônios com XANDÃO. m!caçar",
      type: "PLAYING"
    },
    {
    ...
    {
      name: "Pergunte para mim. m!8ball",
      type: "PLAYING"
    },
    {
    ...
    {
      name: "Encontrou um bug? Reporte com m!bug",
      type: "PLAYING"
    },
    {
    ...
    {
      name: "Sabia que eu tenho um rpg? m!help",
      type: "PLAYING"
    },
    {
      name: "Registre-se um aventureiro com m!register, e vá para aventuras na dungeon com m!dungeon",
      type: "PLAYING"
    },
    {
      name: "#NERFAOSMOBSMEDIOS😢😢😢",
      type: "PLAYING"
    }
  ];
